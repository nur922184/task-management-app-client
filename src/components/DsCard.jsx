...
const DsCard = () => {
    return (
        ...
        <div className="flex justify-center items-center h-screen">
            ...
            <div
                className="group relative flex w-[70%] flex-col rounded-xl bg-slate-950 p-4 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-indigo-500/20"
            >
                <div
